#!/usr/bin/env Rscript
#
# Generates statistical analysis for the untangling tools with p-value, Cohen's d, R^2, and model residuals normality test results.
#
# Arguments:
# - 1: The `decomposition_scores.csv` file generated by `decompose.sh`.
# - 1: The path to the file where the results will be saved.
#
# Output:
