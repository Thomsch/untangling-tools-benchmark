...
# Generates the table comparing the impact of random effects on the linear models and
# outputs the summary of the two models to stdout.
#
# Output: The output file to write the table to in LaTeX format.
#
# Arguments:
