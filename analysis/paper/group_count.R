#!/usr/bin/env Rscript
#
# Generates the table containing the number of group generated by each tool.
# Input: The CSV file containing the combined decomposition results for all the bugs.
