...
"""
Collates the all results of the untangling evaluation (generated by `score.sh`) into a single CSV file
...
def main(evaluation_dir):
    ...
    # The CSV files generated by `clean_decompositions.py` that we want to
    # collate into a single CSV file.
