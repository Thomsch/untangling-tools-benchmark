...
def tangled_patch() -> pd.DataFrame:
    return convert_ground_truth_to_legacy(pd.DataFrame(
        {
...
def test_count_tangled_file(tangled_patch, single_concern_patch, one_tangled_file, multiple_tangled_files, one_tangled_file_and_one_not_tangled_file):
    """
