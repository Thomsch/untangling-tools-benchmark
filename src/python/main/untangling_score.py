...
"""
Calculates the Performance Metric for untangling results of 3
...
def is_only_nonbugfixing_change(df: pd.DataFrame) -> pd.Series:
    """
    For each group generated by tool, return whether the group contains only
    non bug-fixing changes or not.
    Args:
        df: a DataFrame with columns = ['file','source','target','group_truth','group_tool']
    Returns:
